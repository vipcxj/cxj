...
public class XMLWriter extends XMLFilterImpl implements LexicalHandler {
  ...
  // //////////////////////////////////////////////////////////////////
    ...
    public void setOutput(Writer writer) {
        if (writer == null) {
            output = new OutputStreamWriter(System.out, Charsets.UTF_8);
        } else {
            output = writer;
        }
    }
     ...
     * @param prefix The preferred prefix, or "" to select the default
     * Namespace.
     * @see #getPrefix
     ...
     * @param prefix The preferred prefix for the Namespace, or "" for the
     * default Namespace.
     * @see #setPrefix
     * @see #forceNSDecl(java.lang.String)
     */
  ...
  // //////////////////////////////////////////////////////////////////
     ...
     * is none is available. This method will use the qName as a template for
     * generating a prefix if necessary, but it is not guaranteed to use the
     * same qName.
     * @param atts The element's attribute list (must not be null).
     * @exception org.xml.sax.SAXException If there is an error writing the
     * start tag, or if a handler further down the filter chain raises an
     * exception.
  ...
  // //////////////////////////////////////////////////////////////////
     ...
     * chain.
     *
     * @param uri The element's Namespace URI, or the empty string if the
     * element has no Namespace or if Namespace processing is not being
     * performed.
     * @param localName The element's local name (without prefix). This
     * parameter must be provided.
     * @param qName The element's qualified name (with prefix), or the empty
     * string if none is available. This parameter is strictly advisory: the
     * writer may or may not use the prefix attached.
     * @param atts The element's attribute list.
     * @exception org.xml.sax.SAXException If there is an error writing the
     * empty tag, or if a handler further down the filter chain raises an
     * exception.
     * @see #startElement
     * @see #endElement
     */
  ...
  // //////////////////////////////////////////////////////////////////
     ...
     * @exception org.xml.sax.SAXException If there is an error writing the
     * string, or if a handler further down the filter chain raises an
     * exception.
  ...
  // //////////////////////////////////////////////////////////////////
     ...
     * @param isElement true if this is an element name, false if it is an
     * attribute name (which cannot use the default Namespace).
     */
     ...
     * @exception org.xml.sax.SAXException If there is an error writing the
     * character, this method will throw an IOException wrapped in a
     * SAXException.
     */
     ...
     * @param s
     * @exception org.xml.sax.SAXException If there is an error writing the
     * string, this method will throw an IOException wrapped in a SAXException
     */
     ...
     * @exception org.xml.SAXException If there is an error writing the
     * attribute list, this method will throw an IOException wrapped in a
     * SAXException.
     */
     ...
     * @exception org.xml.SAXException If there is an error writing the
     * characters, this method will throw an IOException wrapped in a
     * SAXException.
     */
     ...
     * wrapped in a SAXException if there is an error writing the Namespace
     * declarations.
     */
     ...
     * attribute name.
     * @exception org.xml.sax.SAXException This method will throw an IOException
     * wrapped in a SAXException if there is an error writing the name.
     */
  ...
  // //////////////////////////////////////////////////////////////////
    ...
    private HashMap<String, Boolean> forcedDeclTable;

    private HashMap<String, String> doneDeclTable;
