...
public class ConcurrentIdentityHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    static final class Segment<K, V> extends ReentrantLock {
         ...
         */
        V remove(Object key, int hash, Object value, @SuppressWarnings("SameParameterValue") boolean refRemove) {
            lock();
            try {
                int c = count - 1;
                HashEntry<K, V>[] tab = table;
     ...
     * nonpositive.
     */
    private ConcurrentIdentityHashMap(int initialCapacity, float loadFactor, int concurrencyLevel){
